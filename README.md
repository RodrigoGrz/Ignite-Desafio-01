...
Para que o projeto funcione em sua máquina é necessario ter o <a href="https://nodejs.org/en/">NodeJS</a> instalado.

Depois disso basta instalar as dependências com o comando `npm install` ou `yarn`

Para que o projeto rode use o comando `npm run dev` ou `yarn dev`

Para realizar os testes use o comando `npm run test` ou `yarn test`
